...
setwd("/media/DATA/master/DDSlab/code/tp2")
...
# Clean Text
# kdb_txt$diagnosis_clean = gsub("[[:punct:]]", " ", kdb_txt$diagnosis)
# freq_word <- sort(table(unlist(strsplit(kdb_txt$diagnosis_clean, " "))), decreasing = TRUE)
